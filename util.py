...
def reformat_relay_chat(bot: commmands.Bot, message: discord.Message) -> discord.Message | None:
...
def find_automod_matches(bot: commands.Bot[Patrick], message: discord.Message) -> list[str]:
